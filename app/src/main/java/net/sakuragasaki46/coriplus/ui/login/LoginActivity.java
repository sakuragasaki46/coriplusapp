...
import net.sakuragasaki46.coriplus.SettingsActivity;
import net.sakuragasaki46.coriplus.ui.login.LoginViewModel;
import net.sakuragasaki46.coriplus.ui.login.LoginViewModelFactory;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void setLoadingProgressBar(boolean value){
        if (value){
            loadingProgressBar.setVisibility(View.VISIBLE);
